...
7. 冲突要前置：每个中故事开头必须立刻进入具体矛盾，不要先铺背景、设定说明或慢慢聊天。
8. 每个独立桥段都要同时满足：解决一个当前矛盾、埋下一个新危机/新伏笔、完成一次主角心态或实力弧光。
9. 情绪占比整体向“爽感”倾斜，兼顾虐感、甜感、悬念，但禁止连续长时间纯甜或纯虐。
10. 第一个中故事内部必须严格执行：${variableCardRule}
...
7. 微短剧节奏硬约束（必须遵守）：
   ...
   - 中段剧情推进必须快，不能用铺垫水时长；要有打压、有高潮、有反转、有打脸，并体现鲜明的人物性格
