...
export class BlueprintService {
  ...
  private normalizeMicrodramaEpisodeCount(count?: number): 15 | 30 | 60 | 100 {
    return count === 15 || count === 60 || count === 100 ? count : 30;
  }
...
4. 所有用于推进爱情线的单集或单章，必须从以下“小故事卡”中抽卡组合，并在剧情里自然体现：陷入困境、神器认主、英雄救美、歪打正着、比试、贵人相助、临危受命、寻宝之旅、慧眼识真、因祸得福、好人好报、复仇之路、打情骂俏、幽默搞笑、装B、以小博大、解谜、冒险之旅、特殊对待、争风吃醋、好感变化、洒狗粮、因爱收益、性暗示（仅限成年人之间的合规暧昧张力，不写露骨性内容）。
5. 爱情线单集/单章仍要叠加技法卡：舞台聚光灯、打破预期、信息差、拟感成真、戏剧三角、过激行为、翻弄风云、望远镜、新视角、反差、落差、双刃剑、差异。
...
12. 输出中故事时，凡涉及感情线的集/章，要自然标注或写清：使用的小故事卡、爱情线一级结构、好感度、两人关系阶段、爱情线阶段；不得只写“感情升温”四个字。`;
  }
