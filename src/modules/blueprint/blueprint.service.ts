    ...
    try {
      for (let i = 0; i < loopCount; i++) {
        ...
        const chapterPrompt = mode === 'microdrama'
          ? this.buildMicrodramaEpisodePrompt(contextMemory, currentChapterNum, previousEnding, storyData, dto.actionFirstScript)
          : `${contextMemory}
        ...
        try {
          ...
          for (let storyIndex = 0; storyIndex < loopCount; storyIndex++) {
            ...
            const storyPrompt = mode === 'microdrama'
              ? this.buildMicrodramaEpisodePrompt(storyContext, storyStartChapter, previousEnding, storyData, dto.actionFirstScript)
              : `${storyContext}
