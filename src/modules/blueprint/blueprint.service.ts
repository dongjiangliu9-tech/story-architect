...
7. 微短剧节奏硬约束（必须遵守）：
   ...
   - 如果中故事末尾提供了「阶段状态小结」，10集细纲必须把这一组的终点写到该小结指定的主角状态、人物关系、当前压力与下一阶段目标方向
   - 第1集开头要承接本中故事自身的开端目标；第10集结尾要把“下一阶段目标方向”自然递给下一中故事，但不要提前写下一中故事的核心爆点
...
5. ${mode === 'microdrama'
          ? '按微短剧中故事设计：默认承载10集，内部要有连续压抑、爆发、反转和第10集黑场钩子；结尾必须追加「阶段状态小结」。'
